...
return (
    <SkincareContext.Provider value= {{ products, addProduct, deleteProduct, addReview}}>
        {children}
...
export function useSkincare(){
    ...
    if( !context) throw new Error ('useSkincare debe usarse dentro de SkincarePrvider');
    return context;
}